  ...
  <body>
	...
	<div class="panel panel-primary">
                ...
                <table>
                          <tr>
                            <th><form class="center"> 
                                <a href="areaGestion.jsp" class="btn btn-primary">
        ...
        <table class="bordered striped responsive-table">
           ...
           <form method="get" action="grabaMenor.jsp" autocomplete="off">
        ...
        <form method="get" action="modificaMenor.jsp">
          ...
          <input type="hidden" name="ciclo" autocomplete="off" value="<%=listado.getString("ciclo") %>">
